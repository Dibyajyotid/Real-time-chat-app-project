  ...
  return (
    <div className='h-screen pt-28'>
      <div className='max-w-2xl mx-auto p-4 py-8'>
        <div className='bg-orangy text-white rounded-xl p-6 space-y-8'>
          ...
          <div className='flex flex-col items-center gap-4'>
            ...
            <p className='text-sm text-zinc-300'>
              {isUpdatingProfile ? "Uploading..." : "Click the icon to update your profile picture"}
            </p>
          </div>
          ...
          <div className='pt-6 bg-base-300 rounded-xl p-6'>
