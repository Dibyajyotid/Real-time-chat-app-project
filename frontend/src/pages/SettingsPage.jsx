    ...
    <div className='h-screen container mx-auto px-4 pt-20 max-w-5xl'>
      <div className='space-y-6'>
        ...
        <div className='grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2'>
          {THEMES.map((t) => (
            <button key={t} className={`group flex flex-col items-center gap-1.5 p-2 rounded-lg transition-colors ${theme === t ? "base-bg-200" : "hover:bg-base-200/50"}`} onClick={() => setTheme(t)}>
              ...
              <div className='bg-base-100 rounded-xl shadow-sm overflow-hidden'>
                ...
                <div className='px-4 py-3 border-b border-base-300 bg-base-100'>
                  <div className='flex items-center gap-3'>
                    <div className='size-8 rounded-full bg-orangy flex items-center justify-center text-primary-content font-medium'>
                      3
                    </div>
                    <div>
                ...
                <div className='p-4 border-t border-base-300 bg-base-100'>
                  <div className='flex gap-2'>
                    ...
                    <button className='btn bg-orangy h-10 min-h-0 rounded-lg text-white'>
                      <Send size={18} />
                    </button>
                  </div>
                </div>
